...
/*   Updated: 2021/07/02 09:39:34 by bvalette         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
test_queue_general( void )	{
	...
	}
	{
		...
		ft::queue<int, ft::list<int> >		ft_c0(ft::list<int>(10, 42));
...

	{
		...
		ft::queue<int, ft::list<int> >		ft_c0(ft::list<int>(10, 42));
		std::queue<int, ft::list<int> >		std_c0(ft::list<int>(10, 42));
		ft::queue<int, ft::list<int> >		ft_c1(ft::list<int>(10, 21));
		std::queue<int, ft::list<int> >		std_c1(ft::list<int>(10, 21));
		ft::queue<int, ft::list<int> >		ft_c2(ft::list<int>(11, 21));
		std::queue<int, ft::list<int> >		std_c2(ft::list<int>(11, 21));
