...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   test_vector_at_operatorBrackets.cpp                :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
int
test_vector_at_operatorBrackets( void )	{
	std::cout << TITLE << "~~~~~~~~~~~ " << __func__ << " with ints ~~~~~~~~~~~" << RESET_COLOR << std::endl;
	{
		...
		std::cout << HEADER_TITLE << "Instanciate vector with "<< testSize << " values, a random number of random valueS " << RESET_COLOR << std::endl;
